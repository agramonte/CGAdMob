...
s3e_plink -o "/Users/adriangomez/OneDrive/Development/CGAdmobExample/build_cgadmobexample_xcode/build/${CONFIGURATION}${EFFECTIVE_PLATFORM_NAME}/CGAdmobExample.s3e" --arch=armv6 --compiler=gcc -u -d --usemap="/Users/adriangomez/OneDrive/Development/CGAdmobExample/build_cgadmobexample_xcode/build/${CONFIGURATION}${EFFECTIVE_PLATFORM_NAME}/CGAdmobExample.map" "${TARGET_BUILD_DIR}/${EXECUTABLE_NAME}"
